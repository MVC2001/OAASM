...
if (isset($_POST['submit'])) {
   ...
   $password = md5($_POST['password']);
    ...
    $update_advisor_data = "UPDATE advisor_tbl SET name='$name',position='$position',school='$school',depertment='$depertment',
    role='$role',email='$email',password ='$password' 
    
    WHERE  adv_id='$adv_id'";
    if (mysqli_query($connect, $update_advisor_data)) {
        echo "<div class='alert alert-success' role='alert'><center>Advisor data Updated  Successfull</center></div>";
            header("location:Advisors_account.php");
            exit();
    } else {
        echo "Error: " .$update_advisor_data. "<br>" . mysqli_error($connect);
    }
}
?>
...
<head>
    ...
    <title>UPDATE ADVISORS DATA PANNEL</title>
                        ...
                        <ul class="sidebar-nav" id="sidebar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="#">
                                    ...
                                    <span style="font-size:13px">UPDATE ADVISORS PANNEL</span>
                                </a>
                            </li><br>
                            <hr>
    ...
    <main id="main" class="main">
        ...
        <form action="" method="POST">
            <div class="container-fluid">
                <?php
                $select_student_data = "select * from advisor_tbl where adv_id = '".$_GET['adv_id']."'" or die(mysqli_error($connect));
                    ...
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                     ...
                     <div class="row">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="email" name="email" value="<?php echo $row['email']; ?>" style="border-radius: 20px;height:60px;box-shadow: rgba(0, 0, 0, 0.15) 0px 15px 25px, rgba(0, 0, 0, 0.05) 0px 5px 10px;" autocomplete="off"><br>
                            </div>
